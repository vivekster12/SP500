...
```{r}
test_feats = NULL
for(i in 1:dim(sp500_testing_scaled))
{
  s = i-1+N
...
```{r}
predictions = inverse_minmax_scaler(predictions)
...
```{r}
plot(predictions, type="p", col="red", lwd=2)
#lines(predictions, col="blue",lwd=2)
```
